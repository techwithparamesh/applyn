...
// Industry templates — Appy Pie–style broad category set
const INDUSTRY_TEMPLATES = [
  {
    ...
    description: "Online store, catalog, cart, checkout",
  ...
  },
  {
    ...
    description: "Property listings, agents, inquiries",
  ...
  },
  {
    ...
    description: "Appointments, records, clinics",
  ...
  },
  {
    ...
    description: "Courses, lessons, learning",
    prompt: "Build an education app with course catalog, lessons, quizzes, progress tracking, certificates, instructor profiles, discussion forum, and push notifications for new content.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "offlineScreen", "deepLinking"],
    screens: ["Home", "Courses", "My Learning", "Profile", "More"],
  },
  {
    id: "fitness",
    name: "Fitness",
    ...
    description: "Workouts, classes, memberships",
    prompt: "Build a fitness app with workout plans, class schedules, booking, progress tracking, nutrition tips, trainer profiles, and push reminders for sessions.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "deepLinking"],
    screens: ["Home", "Workouts", "Classes", "Progress", "Account"],
  },
  {
    id: "business",
    name: "Business",
    ...
    description: "Services, contact, company info",
    prompt: "Build a business app with services, team profiles, contact form, testimonials, booking or inquiry, and push notifications for updates.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "whatsappButton", "deepLinking"],
    screens: ["Home", "Services", "Team", "Contact", "More"],
  },
  {
    id: "music",
    name: "Music",
    ...
    description: "Tracks, playlists, events",
    prompt: "Build a music app with artist profile, tracks, playlists, event dates, merch store, and push notifications for new releases and concerts.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "deepLinking"],
    screens: ["Home", "Music", "Events", "Shop", "More"],
  },
  {
    id: "news",
    name: "News & Media",
    ...
    description: "Articles, feeds, notifications",
    prompt: "Build a news app with categories, articles, bookmarks, push notifications for breaking news, and optional offline reading.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "pullToRefresh", "offlineScreen", "deepLinking"],
    screens: ["Home", "Categories", "Saved", "Notifications", "Profile"],
  },
  {
    id: "travel",
    name: "Travel",
    ...
    description: "Trips, bookings, guides",
    prompt: "Build a travel app with destinations, booking, itineraries, tips, maps, and push notifications for deals and reminders.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "deepLinking"],
    screens: ["Explore", "Bookings", "My Trips", "Guides", "Profile"],
  },
  {
    id: "events",
    name: "Events",
    ...
    description: "Events, tickets, schedule",
    prompt: "Build an events app with event listing, ticket booking, schedule, venue info, and push notifications for reminders and new events.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "deepLinking"],
    screens: ["Home", "Events", "My Tickets", "Schedule", "More"],
  },
  {
    id: "entertainment",
    name: "Entertainment",
    ...
    description: "Content, streaming, updates",
    prompt: "Build an entertainment app with content catalog, streaming or links, updates, and push notifications for new releases.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "deepLinking"],
    screens: ["Home", "Browse", "Favorites", "Updates", "Account"],
  },
  {
    id: "social",
    name: "Social",
    ...
    description: "Community, feed, connect",
    prompt: "Build a social app with feed, profiles, messaging or comments, and push notifications for engagement.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "deepLinking"],
    screens: ["Feed", "Explore", "Messages", "Profile", "More"],
  },
  {
    id: "sports",
    name: "Sports",
    ...
    description: "Scores, teams, schedules",
    prompt: "Build a sports app with live scores, teams, schedules, news, and push notifications for match updates.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "pullToRefresh", "deepLinking"],
    screens: ["Home", "Scores", "Teams", "Schedule", "More"],
  },
  {
    id: "lifestyle",
    name: "Lifestyle",
    ...
    description: "Tips, inspiration, content",
    prompt: "Build a lifestyle app with tips, inspiration, articles, and push notifications for daily content.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "pullToRefresh", "deepLinking"],
    screens: ["Home", "Discover", "Saved", "Profile", "More"],
  },
  {
    id: "productivity",
    name: "Productivity",
    ...
    description: "Tasks, notes, tools",
    prompt: "Build a productivity app with tasks, notes, reminders, and push notifications for deadlines.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "offlineScreen", "deepLinking"],
    screens: ["Home", "Tasks", "Notes", "Reminders", "Settings"],
  },
  {
    id: "photography",
    name: "Photography",
    ...
    description: "Portfolio, bookings, gallery",
    prompt: "Build a photography app with portfolio gallery, booking, packages, and push notifications for sessions.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "whatsappButton", "deepLinking"],
    screens: ["Gallery", "Packages", "Book", "About", "Contact"],
  },
  {
    id: "salon",
    name: "Beauty & Salon",
    ...
    description: "Services, booking, offers",
    prompt: "Build a salon or beauty app with services, online booking, stylist profiles, offers, and push notifications for reminders.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "whatsappButton", "deepLinking"],
    screens: ["Home", "Services", "Book", "Offers", "Profile"],
  },
  {
    id: "cafe",
    name: "Cafe & Coffee",
    ...
    description: "Menu, orders, loyalty",
    prompt: "Build a cafe app with menu, ordering, loyalty rewards, and push notifications for offers.",
    suggestedFeatures: ["bottomNav", "pushNotifications", "whatsappButton", "deepLinking"],
    screens: ["Menu", "Order", "Rewards", "Locations", "More"],
  },
  {
    id: "other",
    name: "Other / Custom",
    ...
    prompt: "Build a custom app based on my description with relevant screens and features.",
    suggestedFeatures: ["bottomNav", "pullToRefresh", "offlineScreen", "deepLinking"],
    screens: ["Home", "About", "Contact", "More"],
  },
];
          ...
          {step === "template" && (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-4 text-center max-w-lg mx-auto">
                Choose a category — we’ll suggest screens and features you can edit.
              </p>
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 max-h-[60vh] overflow-y-auto pr-1 -mr-1">
...
function generateSmartAppName(prompt: string, template: typeof INDUSTRY_TEMPLATES[0]): string {
  ...
  const prefixes: Record<string, string[]> = {
    ...
    business: ["Pro", "Biz", "Work"],
    music: ["Sound", "Tune", "Beat"],
    news: ["Daily", "News", "Update"],
    travel: ["Go", "Trip", "Explore"],
    events: ["Event", "Book", "Live"],
    entertainment: ["Play", "Watch", "Stream"],
    social: ["Connect", "Share", "Community"],
    sports: ["Game", "Score", "Team"],
    lifestyle: ["Life", "Daily", "Style"],
    productivity: ["Task", "Do", "Plan"],
    photography: ["Frame", "Shot", "Lens"],
    cafe: ["Brew", "Cafe", "Coffee"],
    realestate: ["Home", "Property", "Space"],
    other: ["My", "The", "Go"],
    custom: ["My", "The", "Go"],
  };
  
  const prefix = prefixes[template.id]?.[Math.floor(Math.random() * (prefixes[template.id]?.length ?? 1))] ?? "My";
