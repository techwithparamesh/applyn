...
const PLANS = [
  {
    ...
    name: "Starter Build",
    price: 499,
    features: ["Basic Android .apk file", "Simple WebView container", "Standard Splash Screen", "Community Support"],
    recommended: false,
  },
  {
    id: "standard",
    name: "Standard Build",
    price: 999,
    features: ["Full Android .apk & .aab files", "Automated WebView Setup", "Basic Push Notification Setup", "Email Support", "1 Year Updates"],
    recommended: false,
  },
  {
    id: "pro",
    name: "Enterprise Pro",
    price: 2499,
    features: ["Android + iOS Ready Files", "Unlimited Push Notifications", "Custom Branding", "Advanced Offline Caching", "Priority WhatsApp Support", "Lifetime Updates"],
    recommended: true,
  },
];
