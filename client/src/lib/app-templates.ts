  ...
  const applyEcommerceVariant = (variant: EcommerceVariant) => {
    ...
    const seed = {
      hero: {
        ...
        buttonAction: "navigate:products",
        backgroundImage: "/api/unsplash/proxy?query=streetwear%20lookbook%20banner&w=1200&orientation=landscape",
      ...
      products: [
        {
          ...
          price: "$79.00",
          originalPrice: "$99.00",
          image: "/api/unsplash/proxy?query=oversized%20hoodie%20streetwear&w=600&orientation=squarish",
          rating: 4.8,
          badge: "Drop",
          category: "Hoodies",
        ...
        },
        {
          ...
          price: "$39.00",
          image: "/api/unsplash/proxy?query=graphic%20tshirt%20streetwear&w=600&orientation=squarish",
          rating: 4.7,
          category: "Tees",
        ...
        },
        {
          ...
          name: "Tech Joggers",
          price: "$69.00",
          image: "/api/unsplash/proxy?query=techwear%20joggers%20pants&w=600&orientation=squarish",
          rating: 4.6,
          badge: "Best Seller",
          category: "New Drops",
        ...
        },
        {
          ...
          price: "$119.00",
          image: "/api/unsplash/proxy?query=high%20top%20sneakers&w=600&orientation=squarish",
          rating: 4.9,
          category: "Sneakers",
        ...
        },
        {
          ...
          price: "$109.00",
          image: "/api/unsplash/proxy?query=washed%20denim%20jacket%20streetwear&w=600&orientation=squarish",
          rating: 4.5,
          category: "New Drops",
        ...
        },
        {
          ...
          name: "Beanie — Minimal",
          price: "$24.00",
          image: "/api/unsplash/proxy?query=minimal%20beanie&w=600&orientation=squarish",
          rating: 4.4,
        ...
        },
        {
          ...
          name: "Cargo Pants",
          price: "$89.00",
          image: "/api/unsplash/proxy?query=cargo%20pants%20streetwear&w=600&orientation=squarish",
          rating: 4.6,
          category: "New Drops",
        ...
        },
        {
          ...
          name: "Cap — Logo",
          price: "$29.00",
          image: "/api/unsplash/proxy?query=black%20cap%20streetwear&w=600&orientation=squarish",
          rating: 4.5,
          category: "Accessories",
      ...
      offers: [
        { title: "Winter Drop", subtitle: "Limited quantities", image: "/api/unsplash/proxy?query=streetwear%20winter%20collection&w=900&orientation=landscape", buttonText: "Shop" },
        { title: "Free Shipping", subtitle: "On orders over $75", image: "/api/unsplash/proxy?query=streetwear%20package%20shipping&w=900&orientation=landscape", buttonText: "Details" },
      ],
      cartItems: [
        { id: "1", name: "UrbanFit Oversized Hoodie", price: "$79.00", quantity: 1, image: "/api/unsplash/proxy?query=oversized%20hoodie%20streetwear&w=300&orientation=squarish" },
        { id: "2", name: "Graphic Tee — Night City", price: "$39.00", quantity: 2, image: "/api/unsplash/proxy?query=graphic%20tshirt%20streetwear&w=300&orientation=squarish" },
        { id: "4", name: "High-Top Sneakers", price: "$119.00", quantity: 1, image: "/api/unsplash/proxy?query=high%20top%20sneakers&w=300&orientation=squarish" },
      ],
    };
