...
// Keep local type names for the rest of this file, but align them to the shared native types.
type _NativeComponent = NativeComponentType;
type _NativeScreen = NativeScreenType;
